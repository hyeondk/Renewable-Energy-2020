---
title: "매출액 회귀선 및 예상 총 매출액 도출 (가중회귀)"
output:
  html_document:
    toc: yes
---
...
dat1 <- read_xlsx("(E3) 발전업 data_바이오폐기물 발전량 추가.xlsx", sheet = 3, skip = 1)
...
dat2 <- read_xlsx("(E3) 발전업 data_바이오폐기물 발전량 추가.xlsx", sheet = 2, skip = 3)

dat2 <- dat2[, c(2, 3, 4, 5, 8, 10)]
names(dat2)[1] <- "에너지원"
names(dat2)[2] <- "용량_kW"
names(dat2)[3] <- "설비코드"
names(dat2)[4] <- "의무대상자여부"
names(dat2)[5] <- "REC_발급_발전량_2019년_기준"
names(dat2)[6] <- "사업체명"
