---
title: "매출액 회귀선 및 예상 총 매출액 도출 (가중회귀)_바이오"
output:
  html_document:
    toc: yes
---
...
dat1 <- read_xlsx("바이오표본조사O(45).xlsx", sheet = 1)
...
# 1. 바이오표본조사O(45).xlsx
#dat11 <- read_xlsx("바이오표본조사O(45).xlsx", sheet = 1)
...
# 2. 바이오표본조사X(8).xlsx
dat12 <- read_xlsx("바이오표본조사X(8).xlsx", sheet = 1, skip = 2)
